...
export type IconName = 'email' | 'user' | 'phone' | 'eye' | 'eye-off' | 'plus' | 'sort' | 'calendar' | 'map' | 'location' | 'trash' | 'x' | 'file-text' | 'shirt' | 'smartphone' | 'pill' | 'backpack' | 'plane' | 'hotel' | 'utensils' | 'target' | 'clipboard';
